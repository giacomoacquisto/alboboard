...
public class welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean noPresentation= sharedPref.getBoolean("noPresentation", false);
        if(noPresentation == true){
    ...
    private void launchHomeScreen() { //TODO PASSAGGIO A CONFIGURAZIONE
        //Variabile booleana per far capire all'altra activity che vengo da qui

        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putBoolean("noPresentation", true);
